...
<div 
  ...
  aria-label="minimize2-icon icon"
  {...restProps}
>
  <svg
    bind:this={svgRef}
  ...
  >
<polyline points="4 14 10 14 10 20" class:animate={currentState === 'running'} />
		<polyline points="20 10 14 10 14 4" class:animate={currentState === 'running'} />
		<line x1="14" x2="21" y1="10" y2="3" class:animate={currentState === 'running'} />
		<line x1="3" x2="10" y1="21" y2="14" class:animate={currentState === 'running'} />
  </svg>
</div>