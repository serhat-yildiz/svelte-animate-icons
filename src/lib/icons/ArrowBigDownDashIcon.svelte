...
<div 
  ...
  aria-label="arrow-big-down-dash-icon icon"
  {...restProps}
>
  <svg
    bind:this={svgRef}
  ...
  >
<path class:animate={currentState === 'running'} d="M15 5H9" />
		<path class:animate={currentState === 'running'} d="M15 9v3h4l-7 7-7-7h4V9z" />
  </svg>
</div>