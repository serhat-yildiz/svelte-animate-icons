...
<div 
  ...
  aria-label="chevrons-right-left-icon icon"
  {...restProps}
>
  <svg
    bind:this={svgRef}
  ...
  >
<path d="m20 17-5-5 5-5" class:animate={currentState === 'running'} />
		<path d="m4 17 5-5-5-5" class:animate={currentState === 'running'} />
  </svg>
</div>