...
<div 
  ...
  aria-label="arrow-big-left-dash-icon icon"
  {...restProps}
>
  <svg
    bind:this={svgRef}
  ...
  >
<path class:animate={currentState === 'running'} d="M19 15V9" />
		<path class:animate={currentState === 'running'} d="M15 15h-3v4l-7-7 7-7v4h3v6z" />
  </svg>
</div>