...
>
  ...
  >
<g class:animate={currentState === 'running'}>
			<path d="M3 6h18" />
			<path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2" />
		</g>
		<path d="M19 8v12c0 1-1 2-2 2H7c-1 0-2-1-2-2V8" class:animate={currentState === 'running'} />
		<line x1="10" x2="10" y1="12" y2="17" class:animate={currentState === 'running'} />
		<line x1="14" x2="14" y1="12" y2="17" class:animate={currentState === 'running'} />
  </svg>
</div>