<script lang="ts">
	...
	// Grip circles 3x3 grid
	const circles = [
		{ cx: 9, cy: 9, delay: 0 },
		{ cx: 12, cy: 9, delay: 0.1 },
		{ cx: 15, cy: 9, delay: 0.2 },
		{ cx: 9, cy: 12, delay: 0.3 },
		{ cx: 12, cy: 12, delay: 0.4 },
		{ cx: 15, cy: 12, delay: 0.5 },
		{ cx: 9, cy: 15, delay: 0.6 },
		{ cx: 12, cy: 15, delay: 0.7 },
		{ cx: 15, cy: 15, delay: 0.8 }
	];
