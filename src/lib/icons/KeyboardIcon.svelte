<script lang="ts">
	...
	// Keyboard keys
	const keyboardPaths = [
		{ id: 'key1', d: 'M4 10h1v1H4v-1z', delay: 0 },
		{ id: 'key2', d: 'M6 10h1v1H6v-1z', delay: 0.1 },
		{ id: 'key3', d: 'M8 10h1v1H8v-1z', delay: 0.2 },
		{ id: 'key4', d: 'M10 10h1v1h-1v-1z', delay: 0.3 }
	];
