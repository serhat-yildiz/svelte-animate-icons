...
<div 
  ...
  aria-label="arrow-big-right-dash-icon icon"
  {...restProps}
>
  <svg
    bind:this={svgRef}
  ...
  >
<path class:animate={currentState === 'running'} d="M5 9v6" />
		<path class:animate={currentState === 'running'} d="M9 9h3V5l7 7-7 7v-4H9V9z" />
  </svg>
</div>