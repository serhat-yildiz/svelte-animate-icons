...
<div 
  ...
  aria-label="maximize2-icon icon"
  {...restProps}
>
  <svg
    bind:this={svgRef}
  ...
  >
<polyline points="15 3 21 3 21 9" class:animate={currentState === 'running'} />
		<polyline points="9 21 3 21 3 15" class:animate={currentState === 'running'} />
		<line x1="21" x2="14" y1="3" y2="10" class:animate={currentState === 'running'} />
