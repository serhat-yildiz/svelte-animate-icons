<script lang="ts">
	...
	export function getControls(): ChevronsRightIconHandle {
		isControlled = true;
...
>
	...
	>
		<path d="m6 17 5-5-5-5" stroke="currentColor" style="opacity: 0.5;" />
		<path d="m13 17 5-5-5-5" stroke="currentColor" />
	</svg>
</div>
