...
>
  ...
  >
<path d="M6 2v14a2 2 0 0 0 2 2h14" class:animate={currentState === 'running'} />
		<path d="M18 22V8a2 2 0 0 0-2-2H2" class:animate={currentState === 'running'} />
  </svg>
</div>