...
<div 
  ...
  aria-label="arrow-big-up-dash-icon icon"
  {...restProps}
>
  <svg
    bind:this={svgRef}
  ...
  >
<path class:animate={currentState === 'running'} d="M9 19h6" />
		<path class:animate={currentState === 'running'} d="M9 15v-3H5l7-7 7 7h-4v3H9z" />
  </svg>
</div>