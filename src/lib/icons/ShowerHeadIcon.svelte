<script lang="ts">
	...
	// Water droplets
	const dropPath = [
		{ id: 'drop1', d: 'M7 16v3', delay: 0 },
		{ id: 'drop2', d: 'M10 16v3', delay: 0.1 },
		{ id: 'drop3', d: 'M13 16v3', delay: 0.2 }
	];
...
<div 
  ...
  aria-label="shower-head-icon icon"
  {...restProps}
>
  <svg
    bind:this={svgRef}
...
<path d="m4 4 2.5 2.5" />
		...
		<g >
			{#each dropPath as { id, d, delay }}
				<path {id} {d}   style="animation-delay: {delay}s;" />
			{/each}
		</g>
  </svg>
</div>